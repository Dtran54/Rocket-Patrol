class Play extends Phaser.Scene {
    ...
    create() {
        // place tile sprite
        this.starfield = this.add.tileSprite(0, 0, 640, 480, 'deserts').setOrigin(0, 0);
        // green UI background
        this.add.rectangle(0, borderUISize + borderPadding, game.config.width, borderUISize * 2, 0xFFFB00 ).setOrigin(0, 0);
        // white borders
        ...
        // add rocket (p1)
        this.p1Rocket = new Rocket(this, game.config.width/2, game.config.height - borderUISize - borderPadding, 'rockets').setOrigin(0.5, 0);
        // add spaceships (x3)
        ...
        this.bike01 = new Bike(this, game.config.width, borderUISize*5 + borderPadding*4, 'bike', 0, 40).setOrigin(0,0);
        // define keys
    ...
    bikeExplode(bike) {
        ...
        let boom = this.add.sprite(bike.x, bike.y, 'explosion').setOrigin(0, 0);
